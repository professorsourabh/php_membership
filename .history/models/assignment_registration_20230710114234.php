...
class AssignmentRegistrationModel
{
    ...
    public function registerUser($username,$first_name, $phone_no,  $email, $password)
    {
        ...
        if (empty($errors)) {
            ...
            $sql = "INSERT INTO membership (name, first_name,phone_no, email, password, verificationCode, verify_status) VALUES ('$username', '$phone_no', '$email', md5('$password'), '$verificationCode', '0')";
