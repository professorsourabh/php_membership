...
class AssignmentRegistrationModel
{
    ...
    public function registerUser($username, $lastname, $firstname, $email, $password)
    {
        ...
        if (empty($errors)) {
            ...
            $sql = "INSERT INTO assignment_registration (username, lastname, firstname, email, password, status, verificationCode, verified) VALUES ('$username', '$lastname', md5('$firstname'), '$email', '$password', $status, '$verificationCode', 'not verified')";
