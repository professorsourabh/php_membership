...
<body>
    ...
    <!-- notification -->
    <div class="col-12 d-flex justify-content-center text-center my-3">
                        ...
                        <div class="form-wrap">
                            <form class="row g-3 needs-validation" id="loginForm" action="./controller/loginController.php" method="post">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="validationCustom" name="verify_name" required>
        ...
        <div class="modal fade" id="Signup" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-wrap">
                            <form class="row g-3 needs-validation" method="post" id="signup" action="./controller/registerController.php">
                                <div class="col-md-12">
...
<div class="col-md-12">
  <label for="validationDefaultConfirmPass" class="form-label">Confirm Password</label>
  <div class="input-group">
    <input type="password" class="form-control" id="validationDefaultConfirmPass" required>
    <div id="confirmPassValidation" class="invalid-feedback"></div>
  </div>
</div>
                                <div class="col-12">
                                    <div class="form-check">
        ...
        <div class="modal fade" id="forgetPassword" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-wrap">
                            <form class="row g-3 needs-validation" method="post" id="forgetpassword" action="./controller/forgetPasswordController.php">
                                <div class="col-md-12">
                                    <label for="emailAddress" class="form-label">Email Address</label>
                                    <input type="text" class="form-control" id="validationCustom2" name="email" required>
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                </div>
                ...
                <div class="col-xl-6">
                    ...
                    <form class="form-subscribe" id="contactFormFooter" data-sb-form-api-token="API_TOKEN">
                        ...
                        <div class="row">
                            ...
                            <div class="col-auto"><button class="btn btn-primary btn-lg disabled" id="submitButton2" type="submit">Submit</button></div>
                        </div>
...
var passwordInput = document.getElementById('validationDefaultpass');
var confirmPassInput = document.getElementById('validationDefaultConfirmPass');
...
confirmPassInput.addEventListener('input', function() {
  ...
  console.log(password+'and'+password);
