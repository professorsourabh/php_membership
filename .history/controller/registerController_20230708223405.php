...
//this is for resgistration whether the user is  registered or not
$sql=mysqli_query($conn,"SELECT id FROM assignment_registration WHERE email='$email' AND password='$password'");
...
if($sql){
    ...
    if (empty($errors)) {
        ...
        $message = 'Hello'.$firstname.', Please click the following link to activate your account: ' . PHP_EOL;
    ...
    $_SESSION['msg']='you have already registered account!';
    echo "<script>
