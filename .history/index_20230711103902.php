...
<body>
    ...
    <section class="modal-wrap">
                            ...
                            <form class="row g-3 needs-validation" id="loginForm" action="./controller/loginController.php" method="post">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="link-wrap d-flex justify-content-between ">
                                        ...
                                        <a href="#">Lost Password</a> <a href="#signup" class="mx-2 my-2" data-bs-toggle="modal" data-bs-target="#Signup">Register</a>
                                    </div>
                                </div>
        ...
        <div class="modal-body" id="lostPasswordForm" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="form-wrap">
            <form class="row g-3 needs-validation" id="lostPasswordForm" action="./controller/lostPasswordController.php" method="post">
                <div class="col-md-12">
