  ...
  <header class="p-3 bg-dark text-white">
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        ...
        <div class="dropdown">
  <div class="row">
    <div class="col-8" style="max-width: 150px;">
      <h2 class="d-inline-block" style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">Hi Sandeep</h2>
    </div>
    <div class="col-4 text-end">
      ...
      <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton">
        ...
        <!-- <a type="button" class="btn btn-danger" href="../controller/logoutController.php">Logout</a> -->
        <!-- </div> -->
      </div>
    </div>
  </header>
