...
<body>
    ...
    <section class="showcase">
        <div class="container-fluid p-0">
            ...
            <div class="row g-0">
                ...
                <div classclass="col-lg-6 order-lg-1 my-auto showcase-text">
                    <h2>Easy to Use & Customize</h2>
                    <p class="lead mb-0">Start Bootstrap has everything you need to get your new website up and running
                        in no time! Choose one of our open source themes, or upgrade to a premium theme with extra
                        features.</p>
                </div>
            </div>
        </div>
    ...
    <!-- Call to Action-->
    <section class="call-to-action text-white text-center" style="background-image: url('assets/img/bg-masthead.jpg')">
                ...
                <div class="col-lg-6 h-100 text-center text-lg-right my-auto">
                    <ul class="list-inline mb-0">
                        <li class="list-inline-item me-4">
                            <a href="#!"><i class="bi-facebook-f"></i></a>
                        </li>
                        <li class="list-inline-item me-4">
