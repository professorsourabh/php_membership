        ...
        <div class="modal fade" id="Signup" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-wrap">
                            <!-- <form class="row g-3 needs-validation" method="post" id="contactForm" action="#"> -->
                            <form class="row g-3 needs-validation" method="post" id="contactForm" action="./controller/registerController.php">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="invalid-feedback" data-bs-feedback="validationDefaultpass:password">Passwords do not match</div>
                                </div>
                                <div class="col-12">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="" id="invalidCheck" required>
