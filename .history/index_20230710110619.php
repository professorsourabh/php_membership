    ...
    <section class="modal-wrap">
        ...
        <div class="modal fade" id="Login" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            unset($_SESSION['msg']);
                            ...
                            <form class="row g-3 needs-validation" action="./controller/loginController.php" method="post">
                                <div class="col-md-12">
                                    <label for="validationCustom01" class="form-label">Username or Email Address</label>
                                    <input type="text" class="form-control" id="validationCustom01" value="" name="verify_name"
                                        required>
                        ...
                        <div class="form-wrap">
                            <form class="row g-3 needs-validation" method="post" action="./controller/registerController.php">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="number" class="form-control" id="validationCustom06" name="phone_no"
                                        required>
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
