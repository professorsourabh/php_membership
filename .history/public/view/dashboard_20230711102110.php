...
?>
  ...
  <body>
    ...
    </header> <div class="container my-4 col-lg-8">
            ...
            <div class="form-wrap">
              <form class="row g-3 needs-validation" method="post" action="../../controller/userController.php">
                ...
                <div class="col-md-12">
                  ...
                  <input type="text" class="form-control" id="validationCustom01" name="last_name" value="<?php echo $userData['last_name']; ?>" required>
                  <div class="valid-feedback">
                    Looks good!
                  </div>
                </div>
