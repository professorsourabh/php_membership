...
<body>
  ...
  <div class="input-group align-items-center">
    <input type="password" class="form-control" name="password" id="exampleInputPassword" placeholder="Password" style="line-height: 1;">
    <span class="input-group-text eye-icon" onclick="togglePasswordVisibility(this, 'exampleInputPassword')" style="line-height: 1.5;">
