                            ...
                            <form class="row g-3 needs-validation" method="post" action="./controller/registerController.php">
                               <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="validationCustom01" name="name" value="<?php echo $userData['first_name']; ?>"
                                        required>
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="number" class="form-control" id="validationCustom06" name="phone_no" <?php echo $userData['first_name']; ?>
                                        required>
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="email" class="form-control" id="validationCustom03" name="email" <?php echo $userData['first_name']; ?>
                                        required>
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
