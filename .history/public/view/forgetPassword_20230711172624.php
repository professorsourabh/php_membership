                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-wrap">
                            ...
                            <input type="text" value="<?php echo base64_encode($_SESSION['id']); ?>" name="id">
                                <div class="form-group">
                                    ...
                                    <div class="input-group align-items-center">
                                        ...
                                        <span class="input-group-text eye-icon" onclick="togglePasswordVisibility(this, 'exampleInputPassword')" style="height: 45px;">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group align-items-center">
                                        <input type="password" class="form-control" name="confirm_password" id="confirm_password" placeholder="confirm password" style="line-height: 1;">
                                        <span class="input-group-text eye-icon" onclick="togglePasswordVisibility(this, 'exampleInputPassword')" style="height: 45px;">
                                            <i class="fas fa-eye"></i>
                                        </span>
                                    </div>
