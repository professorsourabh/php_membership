    ...
    <header class="p-3 bg-dark text-white">
        <div class="container">
          <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            ...
            <div class="text-end">
              ...
              <a type="button" class="btn btn-warning" href="index.html">Sign-up</a>
            </div>
          </div>
        </div>
      </header>
      <div class="container my-4">
        <div class="card my-4" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px;">
            ...
            <div class="card-body">
              <h2 class="text-uppercase fw-bold">Assesment of Theemwiz Web Technologies</h2>
              <h4>Account activated successfully </h4>
              <h3>Please go to <a href="../login.php">login page</a></h3>
