                    ...
                    <div class="modal-body">
                        <div class="form-wrap">
                            ...
                            <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="validationCustom01" value="<?php echo $userData['first_name']; ?>" name="first_name"
                                        required>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="validationCustom01" name="name" value="<?php echo $userData['last_name']; ?>"
                                        required>
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="validationCustom06" name="phone_no" value=<?php echo $userData['phone_no']; ?>
                                        required>
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="email" class="form-control" id="validationCustom03" name="email" value=<?php echo $userData['email']; ?>
                                        required>
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <label for="validationDefaultpass" class="form-label">Update Password </label>
                                    <div class="input-group">
                                      
                                      <input type="password" name="password" value="<?php echo $userData['email']; ?>" class="form-control" id="validationDefaultpass" aria-describedby="inputGroupPrepend2" required>
                                    </div>
                                  </div>
